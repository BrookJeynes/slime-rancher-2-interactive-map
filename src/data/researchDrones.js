export const researchDrones = {
  ...
  "research_1": {
    ...
    log: `I had the drones rebuild the conservatory
...
was still so nice to finally be home again.`,
    archive: `I got the idea for this conservatory from a
...
Maybe I would have been closer to them...`,
  ...
  "research_2": {
    ...
    log: `I sometimes used to bring my lunch here and
...
thoughts I had to share back then?`,
    archive: `Ugh, I forgot my fork. Looks like it's hand
noodles again...`,
    position: [77.45, 144.8],
  },
  "research_3": {
    name: "Research Drone 13",
    log: `I used to be afraid of the water. It felt like
...
get back to work.`,
    archive: `These tidepools remind me of when I
...
new adventures. I guess this is my chance.`,
   position: [78.74, 161.2],
  },
  "research_4": {
    name: "Research Drone 11",
    log: `I had been pacing all over the conservatory
...
That's when it all came to me.`,
    archive: `History is a funny thing. When you're
...
But I really want this.`,
  ...
  "research_5": {
    ...
    log: `Oh mushrooms, my first love. I still
...
didn't know it was special to her.`,
    archive: `Oh good, I was looking for a place to store
...
I bet dad would have laughed at that one.`,
  ...
  "research_6": {
    ...
    log: `Well, here we are again. I'm sending the
...
ended much too soon.`,
    archive: `My gosh, this grass! Just look at the colors
...
It's all too good to be true!`,
    position: [74.87, 117.99],
  },
  "research_7": {
    name: "Research Drone 3",
    log: `I was so in over my head when I first
...
This time I'm going to do it right.`,
    archive: `I just found my first slime fossil on the
...
share.`,
    position: [72.81, 111.31],
  },

  // Ember Valley
  "research_8": {
    name: "Research Drone 4",
    log: `The first time I was here I turned this entire
...
myself.`,
    archive: `Hey, you, wherever you are out there!
...
that's ok with you.`,
    position: [74.32, 74.68],
  },
  "research_9": {
    name: "Research Drone 5",
    log: `I know I'm on a mission here, but that
...
splash like the old days...`,
    ...
    position: [77.87, 63.59],
  },
  "research_10": {
    name: "Research Drone 7",
    log: `I feel at home here. When I traveled
...
pretty sure I'd barf.`,
    archive: `Caves like this have always kind of
...
that brought me here in the first place.`,
    position: [75.56, 49.96],
  },
  "research_11": {
    name: "Research Drone 8",
    log: `I never managed to conclude if the prisma
waves caused all this lava to erupt to the
surface but I belive it did. The rainbow
...
Ugh, I wish I had a dog to pet right now.`,
    archive: `I think I need to just sit here for a minute
...
own.`,
    position: [76.28, 37.84],
  },
  "research_12": {
    name: "Research Drone 9",
    log: `This gate is still sealed too, so I really must
...
It wasn't long before it all collapsed.`,
    archive: `And here we are, back at Ember Valley?
...
discovery. I need to make some calls!`,
    position: [77.91, 25.66],
  },
  "research_13": {
    name: "Research Drone 6",
    log: `When I left the ranch, when I left my home, I
...
have said goodbye.`,
    archive: `I think I've mostly tried to not think about
...
day they'll say they're proud of me.`,
    position: [82.53, 53.83],
  },

  // Starlight Strand
  "research_14": {
    name: "Research Drone 14",
    log: `The prisma waves seem to affect each area
...
back to work.`,
    archive: `I love this spot because it lets you take in
...
this island to do just that.`,
    position: [57.49, 119.22],
  },
  "research_16": {
    name: "Research Drone 17",
    log: `I grew attached to this tree when I first
...
home. I really do.`,
    archive: `Trees like this one can live for thousands
...
and I'm going to eat it every day.`,
    position: [48.57, 104.9],
  },
  "research_18": {
    name: "Research Drone 18",
    log: `I used to start my mornings with a jog
...
by a ringtail slime...`,
    archive: `I'm feeling good today! I think I'm finally
...
YOU HAVE GOT TO BE KIDDING ME!`,
    position: [50.79, 131.26],
  },
  "research_19": {
    name: "Research Drone 19",
    log: `The breach is so much smaller now. It fills
...
coming this far.`,
    archive: `I thought I wasn't going to find a way into
